...
async function loadRecommendations() {
  ...
  if (!data.recommendations.length) container.textContent = data.message || "No recommendations found";
}
...
document.querySelector("#refresh").addEventListener("click", () => handle(loadRecommendations));
